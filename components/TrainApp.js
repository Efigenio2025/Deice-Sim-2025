...
function TrainApp({ forcedMode }) {
  ...
  const controlRail = isMobile ? (
    <div className="pm-mobileControlRail">
      <button type="button" className="pm-btn ghost pm-mobileRailBtn" onClick={onRestart}>
        Restart
      </button>
      <div className="pm-mobileRailToggle">
